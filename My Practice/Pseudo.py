...
#sorted and sort will sort the values in the list in ascending order by default but can be changed to descending order by setting the reverse parameter to True
my_list = [5, 2, 9, 1, 5, 6]
sorted_list = sorted(my_list)
print("Original list:", my_list)
print("Sorted list:", sorted_list)
my_list.sort()
print("Original list after sort:", my_list)     
